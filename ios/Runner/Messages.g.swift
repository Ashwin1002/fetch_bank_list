...
class DeviceInfoApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: DeviceInfoApi?) {
    let getDeviceInfoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.practice.assign_khalti.DeviceInfoApi.getDeviceInfo", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
